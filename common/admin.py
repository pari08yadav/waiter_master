...
class UserProfileAdmin(admin.ModelAdmin):
    ...
    search_fields = ("user__email", "user__username", "user__first_name", "user__last_name", "chain__name")
    list_filter = ("chain",)
...
class MenuItemAdmin(admin.ModelAdmin):
    list_display = ("name", "category", "menu_type", "available", "half_price", "full_price")
    search_fields = ("name", "category__name")
    list_filter = ("category__restaurant", "available", "menu_type", "category")
...
class OrderItemAdmin(admin.ModelAdmin):
    list_display = ("menu_item", "price_type", "price", "quantity", "total_price")
